...
# Source can be found using %%{pypi_source flit_core}. It is available at https://pypi.org/project/flit-core/#files
...
%changelog
* Fri Oct 18 2024 Jocelyn Berrendonner <jocelynb@microsoft.com> - 3.9.0-9
